...
impl FeedforwardGate {
    ...
    * @output The newly created FeedforwardGate object
    */
    ...
    * @output The newly created FeedforwardGate object
    */
    pub fn new2(input_dimension : usize, output_dimension : usize, hiddens_dimensions : Vec<usize>, activation : Activation) -> FeedforwardGate {
    ...
    */
    ...
    /**
    * Initialize the weights using XAVIER algorithm
    ...
    * @input input : The input to compute
    * @output The VerboseOutput object
    */
    ...
    * @output A tuple composed by the input error signal and the last changes
    */
    pub fn backpropagate_error_signal_with_momentum(&mut self, output_v : &VerboseOutput, signal : &Matrix, learning_rate : f64,
        ...
        return (hidden_signal, weights_deltas);
    }
